...
```{r prism-accept, eval = FALSE, echo = TRUE}
library(prism)
...
curl -X POST -H "Content-Type: application/json" -d '{"api_key":["YOUR_API_KEY"],"func":["prism_model_run"],"model_input":[{"ID": "10001",
    "male": 1,
    "age": 70,
    "smoker": 1,
    "oxygen": 1,
    ...
    "randomized_LAMA": 0,
    "randomized_LABA": 0,
    "randomized_ICS": 0}]}' http://prism.resp.core.ubc.ca/ocpu/library/acceptPrism/R/gateway/json
```
...
curl -Body '{"api_key":["YOUR_API_KEY"],"func":["prism_model_run"],"model_input":[{"ID": "10001",
    "male": 1,
    "age": 70,
    "smoker": 1,
    "oxygen": 1,
    ...
    "randomized_LAMA": 0,
    "randomized_LABA": 0,
    "randomized_ICS": 0}]}' -Method POST -uri http://prism.resp.core.ubc.ca/ocpu/library/acceptPrism/R/gateway/json -Headers @{"Content-type"="application/json"}
```
...
```{python prism-python-get, eval = FALSE, echo = TRUE, engine.path = pythonEngine}
import json
import requests
