...
rawHTML <- paste(readLines("html/section-3/createInput-arguments.html"), collapse="\n")
HTML(rawHTML)
```
...
rawHTML <- paste(readLines("html/section-3/getMainResults-describe.html"), collapse="\n")
HTML(rawHTML)
```
...
rawHTML <- paste(readLines("html/section-3/getExResults-describe.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("html/section-3/extended-results-gp.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("html/section-3/extended-results-exacerbation.html"), collapse="\n")
HTML(rawHTML)
```
...
rawHTML <- paste(readLines("html/section-3/plotCOPD-arguments.html"), collapse="\n")
HTML(rawHTML)
```
