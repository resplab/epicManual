...
library(htmltools)
source("readArguments.R")
getItemizeDocs("createInput", TRUE)
rawHTML <- paste(readLines("createInput-arguments.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
getItemizeDocs("getMainResults", keyword="describe")
rawHTML <- paste(readLines("getMainResults-describe.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
getItemizeDocs("getExResults", keyword="describe", maxSize = 8)
rawHTML <- paste(readLines("getExResults-describe.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("extended-results-cardio.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("extended-results-gp.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("extended-results-exacerbation.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
getItemizeDocs("plotExacerbations")
rawHTML <- paste(readLines("plotExacerbations-arguments.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
getItemizeDocs("plotCOPD")
rawHTML <- paste(readLines("plotCOPD-arguments.html"), collapse="\n")
HTML(rawHTML)
```
