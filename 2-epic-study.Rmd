...
library(htmltools)
rawHTML <- paste(readLines("event-table.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("symptoms-table.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("diagnosis-table.html"), collapse="\n")
HTML(rawHTML)
```
...
```{r, eval=TRUE, echo=FALSE}
library(htmltools)
rawHTML <- paste(readLines("physician-table.html"), collapse="\n")
HTML(rawHTML)
```
